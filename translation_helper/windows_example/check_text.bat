rem Ersetzte <drive_letter> mit dem Laufwerkbuchstaben, wo die Texte fuer von Pillars of Eternity: Deadfire liegen: z. B.: d
rem Ersetzte <text_source> mit dem Pfad wo die Texte fuer von Pillars of Eternity: Deadfire liegen: z. B.: poe2_git
rem Ersetzte <drive_letter_helper> mit dem Laufwerkbuchstaben, wo die Helper Dateien liegen: z. B.: d
rem Ersetzte <helper_source> mit dem Pfad, wo die Helper Dateien liegen: z. B.: test_poe2
rem
rem Beispiel:
...
rem
rem In der Datei stringextract.xsl muss text_source noch angepasst werden. Muss der gleich Pfad wie hier in der Batch Datei sein. Also z. B.: PoE_2_git
